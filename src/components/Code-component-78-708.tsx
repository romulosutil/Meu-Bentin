            ...
            <div className="flex flex-col sm:flex-row gap-3 justify-center">
              <Dialog open={modalNovaVenda} onOpenChange={setModalNovaVenda}>
                ...
                <DialogContent className="p-0 gap-0 max-w-7xl w-[95vw] max-h-[95vh] border-0 shadow-xl">
                  <div className="h-full overflow-auto rounded-lg p-8">
                    <div className="mb-6">
                      <h2 className="text-2xl font-bold text-gray-900">Registrar Nova Venda</h2>
                      <p className="text-gray-600 mt-2">Complete os dados da venda e adicione produtos ao carrinho</p>
                    </div>
