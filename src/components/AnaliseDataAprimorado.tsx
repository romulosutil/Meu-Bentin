        ...
        <Card className="bentin-card border-l-4 border-l-bentin-blue">
          <CardHeader>
            <CardTitle className="flex items-center gap-2">
              <div className="bentin-icon-wrapper bg-gradient-to-r from-bentin-blue to-bentin-mint">
              ...
              <Tooltip>
                ...
                <TooltipContent>
                  <p>Análise baseada no histórico de compras dos clientes cadastrados no sistema</p>
                </TooltipContent>
              </Tooltip>
            </CardTitle>
            <CardDescription>
              Insights sobre comportamento e fidelidade dos clientes
            </CardDescription>
          </CardHeader>
          <CardContent>
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-6">
              ...
              <div className="text-center p-4 bg-gradient-to-br from-blue-50 to-blue-100 rounded-xl border border-blue-200">
                <div className="flex items-center justify-center gap-2 mb-2">
                  ...
                  <Tooltip>
                    <TooltipTrigger>
                      <Info className="h-3 w-3 text-blue-400 hover:text-blue-600" />
                    </TooltipTrigger>
                    <TooltipContent>
                      <p>Contagem de todos os clientes que possuem dois ou mais registros de vendas associados</p>
                    </TooltipContent>
                  </Tooltip>
                </div>
                <p className="text-sm text-blue-700 font-medium">Clientes Recorrentes</p>
                <p className="text-2xl font-bold text-blue-800">{analises.clientesRecorrentes}</p>
                <p className="text-xs text-blue-600">
                  de {analises.totalClientes} clientes totais
                </p>
              </div>
              ...
              <div className="text-center p-4 bg-gradient-to-br from-green-50 to-green-100 rounded-xl border border-green-200">
                <div className="flex items-center justify-center gap-2 mb-2">
                  ...
                  <Tooltip>
                    <TooltipTrigger>
                      <Info className="h-3 w-3 text-green-400 hover:text-green-600" />
                    </TooltipTrigger>
                    <TooltipContent>
                      <p>Tempo médio (em dias) que um cliente recorrente leva para fazer uma nova compra</p>
                    </TooltipContent>
                  </Tooltip>
                </div>
                <p className="text-sm text-green-700 font-medium">Frequência Média</p>
                <p className="text-2xl font-bold text-green-800">
                  {analises.frequenciaMediaDias > 0 ? `${analises.frequenciaMediaDias} dias` : '-'}
                </p>
                <p className="text-xs text-green-600">entre compras</p>
              </div>
              ...
              <div className="text-center p-4 bg-gradient-to-br from-purple-50 to-purple-100 rounded-xl border border-purple-200">
                <div className="flex items-center justify-center gap-2 mb-2">
                  ...
                  <Tooltip>
                    <TooltipTrigger>
                      <Info className="h-3 w-3 text-purple-400 hover:text-purple-600" />
                    </TooltipTrigger>
                    <TooltipContent>
                      <p>Percentual de clientes que fizeram mais de uma compra</p>
                    </TooltipContent>
                  </Tooltip>
                </div>
                <p className="text-sm text-purple-700 font-medium">Taxa de Recorrência</p>
                <p className="text-2xl font-bold text-purple-800">
                  {analises.totalClientes > 0 ? 
                    `${Math.round((analises.clientesRecorrentes / analises.totalClientes) * 100)}%` : 
                    '0%'
                  }
                </p>
                <p className="text-xs text-purple-600">dos clientes</p>
              </div>
            </div>
            ...
            <div className="space-y-4">
              <h4 className="font-semibold text-gray-800 flex items-center gap-2">
                ...
                <Tooltip>
                  ...
                  <TooltipContent>
                    <p>Ranking dos clientes que mais gastaram, baseado na soma de todas as compras</p>
                  </TooltipContent>
                </Tooltip>
              </h4>
              {analises.top5Clientes.length > 0 ? (
                <div className="space-y-3">
                  {analises.top5Clientes.map((cliente) => (
                    <div key={cliente.posicao} className="flex items-center justify-between p-3 bg-gradient-to-r from-slate-50 to-white rounded-lg border">
                      <div className="flex items-center gap-3">
                        <div className={`rounded-full w-8 h-8 flex items-center justify-center font-bold text-sm text-white ${
                          cliente.posicao === 1 ? 'bg-yellow-500' :
                          cliente.posicao === 2 ? 'bg-gray-400' :
                          cliente.posicao === 3 ? 'bg-orange-600' : 'bg-blue-500'
                        }`}>
                          {cliente.posicao}
                        </div>
                        <div>
                          <p className="font-semibold">{cliente.nomeCliente}</p>
                          <p className="text-sm text-muted-foreground">{cliente.numeroCompras} compras</p>
                        </div>
                      </div>
                ...
                <div className="text-center py-8 text-muted-foreground">
                  ...
                  <p>Nenhum cliente com compras registradas ainda</p>
                </div>
              )}
            </div>
          </CardContent>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
              <div className="text-center p-4 bg-gradient-to-br from-green-50 to-green-100 rounded-xl border border-green-200">
                <div className="flex items-center justify-center gap-1 mb-2">
                  ...
                  <Tooltip>
                    ...
                    <TooltipContent>
                      <p>Soma total da receita de todas as vendas concluídas nos últimos 30 dias</p>
                    </TooltipContent>
                  </Tooltip>
                </div>
              ...
              <div className="text-center p-4 bg-gradient-to-br from-blue-50 to-blue-100 rounded-xl border border-blue-200">
                <div className="flex items-center justify-center gap-1 mb-2">
                  ...
                  <Tooltip>
                    ...
                    <TooltipContent>
                      <p>Número total de vendas com status 'concluída' registradas no sistema</p>
                    </TooltipContent>
                  </Tooltip>
                </div>
              ...
              <div className="text-center p-4 bg-gradient-to-br from-purple-50 to-purple-100 rounded-xl border border-purple-200">
                <div className="flex items-center justify-center gap-1 mb-2">
                  ...
                  <Tooltip>
                    ...
                    <TooltipContent>
                      <p>Valor total do estoque atual (preço de venda × quantidade de cada produto)</p>
                    </TooltipContent>
                  </Tooltip>
                </div>
              ...
              <div className="text-center p-4 bg-gradient-to-br from-orange-50 to-orange-100 rounded-xl border border-orange-200">
                <div className="flex items-center justify-center gap-1 mb-2">
                  ...
                  <Tooltip>
                    <TooltipTrigger>
                      <Info className="h-3 w-3 text-orange-400 hover:text-orange-600" />
                    </TooltipTrigger>
                    <TooltipContent>
                      <p>Produtos com estoque baixo (abaixo do mínimo) ou esgotados (quantidade zero)</p>
                    </TooltipContent>
                  </Tooltip>
                </div>
