// =====================================================
// COMPONENTE DE VENDAS SIMPLIFICADO
// =====================================================
...
const VendasSimplificadas = () => {
  ...
  const finalizarVenda = useCallback(async () => {
    ...
    if (!formVenda.vendedorId) {
      addToast({
        type: 'error',
        title: 'Vendedor necessário',
  ...
  const renderModals = useCallback(() => {
    ...
    modalNovaVenda, modalNovoVendedor, modalDetalhesVenda, modalGerenciarClientes,
    modalDebugClientes, modalSelecionarCliente, clienteVenda, formVenda,
    carrinhoItens, totalCarrinho, vendaSelecionada, buscaCliente, clientesFiltrados,
    novoClienteRapido, produtos, produtoSelecionado, quantidadeProduto, vendedores,
    formVendedor, isLoading
  ]);
    ...
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
        ...
        <StatsCard
          ...
          description={getPeriodoLabel(filtros.periodo).toLowerCase()}
          icon={<TrendingUp />}
          color="warning"
        />
      </div>
          ...
          <FormSection title="Filtros" icon={<Filter className="h-5 w-5" />}>
            <FormGrid cols={4}>
              ...
              <FormField label="Vendedor">
                <Select value={filtros.vendedor} onValueChange={(valor) => atualizarFiltro('vendedor', valor)}>
                  <SelectTrigger>
...
export default VendasSimplificadas;